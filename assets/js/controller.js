            ...
            constructor(views) {
                class RecipeForms {
                    constructor(views) {
                        ...
                        this.viewForm = { title: "Visualizza ricetta", name: "recipeViewForm", path: "forms/recipe/recipeViewForm/recipeViewForm", parent: views.allViews.manageRecipes, ribbon: [ ribbon.buttons.back, ribbon.buttons.takeCharge ] };    
                    }
                }
