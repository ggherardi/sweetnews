            ...
            constructor(views) {
                class RecipeForms {
                    constructor(views) {
                        ...
                        this.editForm = { title: "Modifica e invia ricetta", name: "recipeNewForm", path: "forms/recipe/recipeEditForm/recipeEditForm", parent: views.allViews.manageRecipes, ribbon: [ ribbon.buttons.back, ribbon.buttons.save, ribbon.buttons.delete, ribbon.buttons.send ] };    
